...
<body>
    ...
    <div class="main">
        <?php $this->load->view('includes/top-nav-bar', ['page_title' => $page_title ?? 'Dashboard']); ?>
        <main class="content">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="stat-card">
                    ...
                    <div>
                        <div class="stat-value"><?= $counts['judges'] ?></div>
                ...
                <div class="stat-card">
                    ...
                    <div>
                        <div class="stat-value"><?= $counts['candidates'] ?></div>
            ...
            <div class="row">
                <div class="col-12">
                    <div style="background:#FFFFFF;border:1px solid var(--border);border-radius:12px;padding:2rem;text-align:center">
                        <h3 style="font-size:1.1rem;font-weight:600;margin-bottom:.5rem">Welcome, <?= htmlspecialchars($this->session->userdata('admin_name')) ?></h3>
                        <?php if ($this->session->userdata('admin_role') === 'tabulator'): ?>
                            <p style="color:var(--muted);font-size:.9rem">Review the standings, finalize each round's advancement, and print the official results from the sidebar.</p>
                            <div style="margin-top:1.5rem;display:flex;gap:.6rem;justify-content:center;flex-wrap:wrap">
                                <a href="<?= site_url('judgedashboard/tabulation') ?>" class="btn-gold">View Tabulation</a>
                                <a href="<?= site_url('admin/rounds') ?>" class="btn-outline">Round Advancement</a>
                            </div>
                        <?php else: ?>
                            <p style="color:var(--muted);font-size:.9rem">Manage your pageant data from the sidebar. Start by creating an event, then add categories, criteria, candidates, and judges.</p>
                            <div style="margin-top:1.5rem;display:flex;gap:.6rem;justify-content:center;flex-wrap:wrap">
                                <a href="<?= site_url('admin/events') ?>" class="btn-gold">Manage Events</a>
                                <a href="<?= site_url('admin/candidates') ?>" class="btn-outline">Add Candidates</a>
                                <a href="<?= site_url('admin/judges') ?>" class="btn-outline">Add Users</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
