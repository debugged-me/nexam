<?php if (!empty($subject_context)): ?>
    <?php
    $subject_links = [
        'overview'  => ['label' => 'Overview',   'url' => site_url('subjects/view/' . $subject_context->id)],
        'questions' => ['label' => 'Questions',  'url' => site_url('questions?subject_id=' . $subject_context->id)],
        'tos'       => ['label' => 'Blueprints', 'url' => site_url('tos?subject_id=' . $subject_context->id)],
        'exams'     => ['label' => 'Exams',      'url' => site_url('exams?subject_id=' . $subject_context->id)],
    ];
    ?>
