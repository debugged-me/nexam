...
<body class="auth-page">
    ...
    <main class="auth-wrap" id="main-content" tabindex="-1">
        ...
        <div class="auth-form-wrap">
            ...
            <form action="<?php echo site_url('verify/submit'); ?>" method="post">
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <div class="form-group">
                    <label class="form-label" for="code">Verification Code</label>
                    <div class="input-wrap">
                        <input type="text" id="code" name="code" class="form-input code-input" placeholder="000000" maxlength="6" pattern="[0-9]{6}" inputmode="numeric" autocomplete="one-time-code" required autofocus>
                    </div>
                </div>
            ...
            <form action="<?php echo site_url('verify/resend'); ?>" method="post" class="auth-secondary-form">
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <button type="submit" class="btn-register">
                    <i data-lucide="refresh-cw"></i> Resend Code
                </button>
            </form>
